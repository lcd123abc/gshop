<template>
  <div class="loginContainer">
    <div class="loginInner">
      <div class="login_header">
        ...
        <div class="login_header_title">
          <a href="javascript:;" :class="{on: active}" @click="active=true">短信登录</a>
          <a href="javascript:;" :class="{on: !active}" @click="active=false">密码登录</a>
        </div>
      </div>
          ...
          <div :class="{on: active}">
            <section class="login_message">
              ...
              <button :disabled="!rightPhone" class="get_verification" :class="{right_phone:rightPhone}" @click.prevent="getCode">
                {{computedCount == 0 ? '获取验证码' : `已发送${computedCount}s` }}
              </button>
            </section>
    ...
    <AlertTip :alertText='alertText' @closeTip='closeTip' v-show="isShowTip"/>
  </div>
</template>
